...
parser = DemoParser("D:/Demos/DightedAnubisTest.dem")
...
df = parser.parse_ticks(["pitch", "yaw",  "X", "Y", "Z", "team_name"])
...
# attacker_deaths = player_death_df[player_death_df["user_name"] == attacker_name].sort_values(by="tick")
...
# attacker_deaths.to_excel("deaths.xlsx")
